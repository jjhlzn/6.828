...
serve_read(envid_t envid, union Fsipc *ipc)
{
	...
	int want_read_bytes = req->req_n > PGSIZE ? PGSIZE : req->req_n;
	int read_bytes;
	if ((read_bytes = file_read(o->o_file, fsreq, 
									want_read_bytes, o->o_fd->fd_offset)) < 0)
		return r;
	o->o_fd->fd_offset += read_bytes;
	return read_bytes; 
}
